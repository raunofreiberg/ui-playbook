import { Popover, Button, MdxLink } from '../../components';
...
> If you're looking to display content on hover, refer to <MdxLink href="/play/tooltip">Tooltip</MdxLink>.
...
If the content of a popover is plain text and not meant to be interacted with, consider using a <MdxLink href="/play/tooltip">Tooltip</MdxLink> instead.
