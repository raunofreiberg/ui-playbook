...
import { Select, Option } from '@modulz/radix';
...
### Consider select when you have 4 or more options
...
### [Reach UI (React)](https://reach.tech/listbox/)

We recommend using Reach UI's listbox as a base for your React based implementation.

<Listbox defaultValue="option1">
    <ListboxOption value="option1">Option one</ListboxOption>
    <ListboxOption value="option2">Option two</ListboxOption>
    <ListboxOption value="option3">Option three</ListboxOption>
</Listbox>

<hr />

### [Modulz — Radix (React)](https://radix.modulz.app/docs/select/)
...
The accessibility requirements for this component are defined by the [WAI-ARIA Practices 1.1 for Listbox](https://www.w3.org/TR/wai-aria-practices/#Listbox):
...
- [WAI-ARIA Practices 1.1 - Listbox](https://www.w3.org/TR/wai-aria-practices/#Listbox)
