import { MdxLink, TextField } from '../../components';
...
If necessary, used in combination with a <MdxLink href="/play/tooltip">Tooltip</MdxLink> to provide a brief explanation on hover.
...
<TextField placeholder="Placeholder" icon="search" inline />

Or, an autocomplete input could provide a button with a cross icon to clear the current value.

<TextField value="Apple" onChange={() => {}} icon="close" inline />
...
<TextField type="email" value="joe@doe.com" onChange={() => {}} hint="Your e-mail will not be used for newsletters." inline />
...
<TextField placeholder="Placeholder" label="Field label" inline required />
...
<TextField placeholder="Placeholder" label="Field label" inline optional />
